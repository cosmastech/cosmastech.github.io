...
I was assigned to build a project a few years ago, starting totally from scratch. I, like I think many developers, find greenfield to be alluring. I can admit I told my manager "I'm not going to write it the Laravel way, I'm going to write it _the right way_."  It didn't take longer than four months for me to begin to see that the choices I made were making maintenance, development, and changes harder for me and the developers who had to jump on the project.
...
A haiku is about paring away the unnecessary until we are left with its essence. Writing code is not an ancient art of Zen masters, but neither is it a hard science without deviation. There are no masters of software engineering who can dictate precisely how effective code is written for you, your domain, or your team.
