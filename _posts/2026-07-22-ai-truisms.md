...
_Con man_ is short for "confidence man," someone who abuses their victims' trust by projecting confidence. AI is a token generation process. In my experience, LLMs don't stop and ask me to clarify when they don't understand what I'm asking. Skill issue.

AI doesn't understand business context unless it's provided. Business context is usually very deep, scattered in many places, and it's [hard to recognize our implicit understanding](https://en.wikipedia.org/wiki/Curse_of_knowledge) that we don't put into context.
